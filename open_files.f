...
OPEN(20001,FILE='P_G',form='formatted')
!OPEN(20004,FILE='MU_G',form='unformatted')
OPEN(20006,FILE='EP_G',form='formatted')
!OPEN(80006,FILE='EP_Gb',form='unformatted')
!OPEN(20010,FILE='MU_S1',form='formatted')
OPEN(20012,FILE='T_G',form='formatted')
OPEN(20013,FILE='T_S1',form='formatted')
OPEN(20014,FILE='T_S2',form='formatted')
OPEN(20015,FILE='U_G',form='formatted')
OPEN(20016,FILE='V_G',form='formatted')
OPEN(20017,FILE='U_S1',form='formatted')
OPEN(20018,FILE='U_S2',form='formatted')
OPEN(20019,FILE='V_S1',form='formatted')
OPEN(20020,FILE='V_S2',form='formatted')
OPEN(20007,FILE='RO_G',form='formatted')
OPEN(20023,FILE='ROP_S1',form='formatted')
...
OPEN(20033,FILE='ROP_S2',form='formatted')
!OPEN(20034,FILE='R_HUM',form='formatted')
!OPEN(20035,FILE='R_TEMP',form='formatted')
...
OPEN(20038,FILE='W_G',form='formatted')
OPEN(20039,FILE='W_S1',form='formatted')
OPEN(20040,FILE='W_S2',form='formatted')
OPEN(20041,FILE='X_G2',form='formatted')

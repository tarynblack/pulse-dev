...
!              -----------------------------------------------------
                  MW_MIX_G(IJK) = MW
   !               IF (P_G(IJK)<=0.0) THEN
   !                   IF (P_G(FUNIJK(I_OF(IJK)+1,J_OF(IJK),1))>0.0) THEN
   !                      P_G(IJK)=P_G(FUNIJK(I_OF(IJK)+1,J_OF(IJK),1))
   !                   ELSE
   !                      P_G(IJK)=1e2
   !                   END IF
   !               END IF
                  ...
                  RO_G(IJK) = EOSG(MW,P_G(IJK),T_G(IJK),J_OF(IJK))
  ...
  !                END IF
                  ...
                  RO_G(IJK) = EOSG(MW_AVG,P_G(IJK),T_G(IJK),J_OF(IJK))
                  ROP_G(IJK) = RO_G(IJK)*EP_G(IJK)
               ENDIF
!	       

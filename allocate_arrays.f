...
!ALLOCATE(VENT_CONDITIONS1(7,837))
!ALLOCATE(VENT_CONDITIONS2(7,837))
!ALLOCATE(VENT_CONDITIONS3(7,837))
!ALLOCATE(CRATER_LOC2(IMAX,KMAX))
...
!ALLOCATE (PARTICLE_UNIQUE(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
!ALLOCATE (PARTICLE_INLET_FRAC(MMAX))

ALLOCATE (PARTICLE_IMPACT(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (DENSITYP(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (DIAMETER(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (PPU(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (PPV(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (PPX(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (PPY(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (Fgpu(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (Fgpv(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (Fspu(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (Fspv(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))

ALLOCATE (Pug1(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))
ALLOCATE (Pvg1(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))

ALLOCATE (LAG_VOL(0:int((TIME_STOP_LAG-TIME_START_LAG)/DT)*DT_LAG))

!Allocate(SUM_WATER_LOSS(IMAX+2,KMAX+2))
!Allocate(SUM_DEPOSIT(IMAX+2,KMAX+2))
!Allocate(WATER_LOSS1(IMAX+2,KMAX+2))
!Allocate(WATER_LOSS2(IMAX+2,KMAX+2))
!Allocate(WATER_LOSS3(IMAX+2,KMAX+2))
!Allocate(WATER_LOSS4(IMAX+2,KMAX+2))
!Allocate(HEIGHTBB(IMAX+2,KMAX+2))
!Allocate(HBB(IMAX,KMAX))
!Allocate(DEPOSIT_1(IMAX+2,KMAX+2))
!Allocate(DEPOSIT_2(IMAX+2,KMAX+2))
!Allocate(DEPOSIT_3(IMAX+2,KMAX+2))
!Allocate(DEPOSIT_4(IMAX+2,KMAX+2))
!


!Allocate(  BOUNDARY_CELL(DIMENSION_3))
!Allocate(  GX(DIMENSION_3))
!Allocate(  GY(DIMENSION_3))
!Allocate( GZ(DIMENSION_3))

Allocate(  U_cg (DIMENSION_3) )
Allocate(  V_cg (DIMENSION_3) )
Allocate(  W_cg (DIMENSION_3) )

Allocate(  UOLD (DIMENSION_3) )
Allocate(  VOLD (DIMENSION_3) )
Allocate(  WOLD (DIMENSION_3) )




  Allocate(  R_HUM(DIMENSION_3) )
  Allocate(  RR_TEMP(DIMENSION_3) )
  Allocate(  COLL_RATE(DIMENSION_3))
...
Write(254698,*)'WRITE_OUT',TIME_INTERVAL
Write(254698,*)'END_TIME',TSTOP
